      ...
      <View style={styles.root}>
        <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.successCard}>
            ...
            <Text style={styles.successSubtitle}>Margaret Johnson — Feb 18, 2026</Text>
          </View>

          {/* Stats Grid */}
          <View style={styles.statsGrid}>
            <View style={styles.statBox}>
                <Text style={styles.statValue}>3h 58m</Text>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.uiCard}>
                <DetailRow label="Clock In" value="8:02 AM" />
                <DetailRow label="Clock Out" value="11:59 AM" />
                <DetailRow label="Total Duration" value="3h 58m" valueStyle={{ color: '#3D8A5A' }} />
          ...
          <View style={styles.section}>
            ...
            <View style={styles.uiCard}>
                <Text style={styles.notesText}>
                    Client was in good spirits today. Administered all morning medications on schedule. Assisted with bathing and prepared lunch. Vital signs stable — BP 128/82, Temp 98.4F.
                </Text>
